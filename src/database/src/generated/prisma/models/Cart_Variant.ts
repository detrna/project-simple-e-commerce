...
// @ts-nocheck 
/*
 * This file exports the `Cart_Variant` model and its related types.
 *
...
export type GetCart_VariantAggregateType<T extends Cart_VariantAggregateArgs> = {
      [P in keyof T & keyof AggregateCart_Variant]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCart_Variant[P]>
    : Prisma.GetScalarType<T[P], AggregateCart_Variant[P]>
}
...
export type GetCart_VariantGroupByPayload<T extends Cart_VariantGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Cart_VariantGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Cart_VariantGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Cart_VariantGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Cart_VariantGroupByOutputType[P]>
      }
    >
  >
...
export type Cart_VariantCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<Cart_VariantFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface Cart_VariantDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['Cart_Variant'], meta: { name: 'Cart_Variant' } }
  /**
   ...
   * })
  **/
  count<T extends Cart_VariantCountArgs>(
    args?: Prisma.Subset<T, Cart_VariantCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Cart_VariantCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends Cart_VariantGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, Cart_VariantGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCart_VariantGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
