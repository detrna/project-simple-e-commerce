...
// import { Category, Sub_Category, Shipment } from "../generated/prisma";
...
async function seed() {
  ...
  // STORES
  const stores = [
    { id: "store-1", address: "Jakarta", email: "store1@mail.com", userId: "user-1" },
    { id: "store-2", address: "Bandung", email: "store2@mail.com", userId: "user-2" },
    { id: "store-3", address: "Surabaya", email: "store3@mail.com", userId: "user-3" },
  ];
